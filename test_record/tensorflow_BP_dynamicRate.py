...
def tensorflow_bp_dynamic(filename):
    ...
    LEARNING_RATE_BASIC = 0.5 #基础学习率 0.8
    LEARNING_RATE_DECAY = 0.99 #学习率衰减 0.99
    ...
    learning_rate = tf.train.exponential_decay(
        LEARNING_RATE_BASIC,
        global_step,
        mnist.train.num_examples,  # 过完所有的训练数据迭代次数。
...
if __name__ == '__main__':
    ...
    tensorflow_bp_dynamic(filename)
