...
def plot_compare_training_cost(training_cost, training_old_cost, num_epochs, training_cost_xmin):
    ...
    ax.plot(np.arange(training_cost_xmin, num_epochs),
            ...
            color='#2A6EA6',
            label='Cost on the  BP(Regularization) test data')
    ax.plot(np.arange(training_cost_xmin, num_epochs),
...
def plot_compare_training_accuracy(training_accuracy, training_old_accuracy, num_epochs,
    ...
    ax.plot(np.arange(training_accuracy_xmin, num_epochs),
            ...
            color='#2A6EA6',
            label="Accuracy on the  BP(Regularization) test data")
    ax.plot(np.arange(training_accuracy_xmin, num_epochs),
            [accuracy*100.0/training_set_size
...
if __name__ == "__main__":
    filename = input("Enter a file name(suggest reg_new): ")
    filename_old = input("Enter a file name(suggest reg_old): ")
    ...
    lmbda = float(input(
        "Enter the regularization parameter, lambda(regularization) (suggest: 5.0): "))
